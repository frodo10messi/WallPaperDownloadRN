...
const { height, width } = Dimensions.get('window');
  ...
  loadWallpapers = ()=>{
    Axios.get('https://api.unsplash.com/photos/random?count=30&client_id=11e658143cd983960ab78ee19e94c3b97bf0991a7f32f0b1e6cd8a3b324d12df'
    ).then((response)=>{
    ...
    return (
      <View style={{ flex: 1 }}>
          ...
          <TouchableWithoutFeedback onPress = {()=>{
            ...
            <Image style = {{flex:1,height:null , width:null }} source ={{uri:item.urls.regular}} >
